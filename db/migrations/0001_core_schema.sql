-- Core schema per docs/09-data-model-and-storage.md §9.4, plus hub identity tables
-- from docs/07-identity-and-access.md §7.3-7.4 needed to support entitlement checks.
